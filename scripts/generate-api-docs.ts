...
const endpoints: Endpoint[] = [
  ...
  // Support Tickets
  {
    ...
    auth: "session",
    description: "List support tickets (admins see all, non-admins see own)",
    responseDescription: "{ tickets: Ticket[], total, page, pageSize, stats? }",
  },
  {
    method: "POST",
    path: "/api/support-tickets",
  ...
  },
  {
    ...
    auth: "session",
    description: "Get a ticket with replies (own ticket or admin)",
    responseDescription: "{ ticket: Ticket, replies: Reply[] }",
  ...
  },
  {
    ...
    path: "/api/support-tickets/:id",
    auth: "session",
    description: "Update a ticket (admin: status/priority; owner: title/desc on open tickets)",
  ...
  },
  {
    ...
    auth: "session",
    description: "List replies for a ticket (own ticket or admin)",
  ...
  },
  {
    ...
    path: "/api/support-tickets/:id/replies",
    auth: "session",
    description: "Post a reply to a ticket (own ticket or admin)",
  ...
  },
  {
    ...
    auth: "admin",
    description: "Get ticket counts by status for the workspace",
